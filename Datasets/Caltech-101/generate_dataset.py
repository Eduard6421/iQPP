...
def generate_dataset(src_folder, dest_folder, avoid_queries):
    ...
    del dataset_categs["BACKGROUND_Google"]
...
if __name__ == "__main__":
    ...
    cfg = generate_dataset(src_folder=SRC_FOLDER,dest_folder=DEST_FOLDER,avoid_queries = [])

    with open('gnd_caltech101_700.pkl','wb') as handle:
